...
class CouponController extends ApiController
{
    protected $validationRules = [
        ...
        'settings.merchants.*'          =>  'distinct|exists:users,deleted_at,NULL',
        'settings.users.*'              =>  'distinct|exists:users,deleted_at,NULL',
        'settings.days_of_week.*'       =>  'integer|between:1,7',
        'settings.room_type.*'          =>  'integer|between:1,5',
    ...
    protected $validationMessages = [
        ...
        'settings.days_of_week.*.integer'   =>  'Ngày trong tuần không hợp lệ',
        'settings.days_of_week.*.between'   =>  'Mã ngày trong tuần không đúng',
        'settings.room_type.*.integer'      =>  'Loại phòng không hợp lệ',
        'settings.room_type.*.between'      =>  'Loại phòng không phù hợp',
