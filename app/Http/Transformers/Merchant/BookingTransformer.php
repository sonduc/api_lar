...
use App\Http\Transformers\BookingStatusTransformer;
...
class BookingTransformer extends TransformerAbstract
{
    ...
    public function transform(Booking $booking = null)
    {
        ...
        return [
            ...
            'status_host_reviews'       =>  $booking->status_host_reviews,
            'status_host_reviews_txt'   => $booking->status_host_reviews ==1 ? 'Đã Review' : 'Chưa Review',
