...
class SendCouponRegisterUser extends Job
{
    public $tries = 5;
    public $user;
    public $coupon;
    ...
    public function handle()
    {
        ...
        try {
            Mail::send('email.user_register_coupon_referral', ['data' => $dataUser,'coupon' => $dataCoupon,"setting" => $dataSetting], function ($message) use ($email) {
