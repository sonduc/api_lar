...
class Booking extends Entity
{
    ...
    protected $fillable = [
        ...
        'status', 'number_of_guests', 'service_fee', 'type', 'booking_type', 'payment_method', 'payment_status', 'price_range', 'source', 'exchange_rate', 'payment_method_txt','settings','total_refund',
    ];
