...
class Booking extends Entity
{
    ...
    protected $fillable = [
        ...
        'status', 'email_reminder', 'email_reviews', 'number_of_guests', 'service_fee', 'type', 'booking_type', 'payment_method', 'payment_status', 'price_range', 'source', 'exchange_rate', 'total_refund', 'settings', 'age_range','host_reminder','review_url','status_reviews'
    ];
