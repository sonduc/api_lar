    ...
    <body style="font-family: Helvetica, Arial, sans-serif;font-size: 14px;line-height: 1.4;">
        <table style="margin: 0 auto; width: 100%;max-width: 580px;">
            <tbody>
                ...
                <tr>
                    <td colspan="2">
                        <p style="margin: 0;margin-top: 20px;font-size: 16px;">Xin chào <span style="color: #f5a623;font-weight: 600;">{{ $data->name }}</span></p>
                    </td>
                </tr>
                <tr>
                    <td colspan="2">
                ...
                <tr>
                    ...
                    <td>
                        <p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;"> {{ $data->room->roomTrans[0]->name }}
                        </p>
                    </td>
                </tr>
                ...
                @if (!empty($status))
                    <tr>
                        ...
                        <td>
                            <p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;"> {{ $data->room->address }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;"> {{ $data->merchant->name }}</p>
                        </td>
                    </tr>
                    <tr>
                        <td><p style="margin:  0;color: #777; margin-bottom: 8px;">Số điện thoại chủ nhà</p></td>
                        <td><p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;"><a href="tel:{{ $data->merchant->phone }}">{{ $data->merchant->phone  }}</a> </p></td>
                    </tr>
                @else
                    <tr>
                        <td>
                        ...
                        <td>
                            <p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;">
                                @if ($data->room)
                                    {{ $data->room->district->name }}, {{ $data->room->city->name}}
                                @endif
                             </p>
                        </td>
                    </tr>
                ...
                <tr>
                    ...
                    <td>
                        <p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;"> {{ $data->name }}</p>
                    </td>
                </tr>
                <tr>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px;">Email</p></td>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;">{{ $data->email }} </p></td>
                </tr>
                <tr>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px;">Số điện thoại</p></td>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;"><a href="tel:{{ $data->phone }}">{{ $data->phone }}</a> </p></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;">{{ $data->code }}</p></td>
                </tr>
                <tr>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px;">Ngày đến</p></td>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;">{{  date('H:i d-m-Y', $data->checkin)  }}</p></td>
                </tr>
                <tr>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px;">Ngày đi</p></td>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;">{{ date('H:i d-m-Y', $data->checkout) }}</p></td>
                </tr>
                <tr>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px;">Tổng</p></td>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;"><b>{{ number_format($data->total_fee )}}đ</b> </p></td>
                </tr>
                <tr>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px;">Trạng thái thanh toán</p></td>
                    <td><p style="margin:  0;color: #777; margin-bottom: 8px; text-align: right;"><b>{{ $data->getPaymentStatus() }}</b> </p></td>
                </tr>
                <tr>
