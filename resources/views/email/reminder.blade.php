...
<head>
  ...
  <title>Untitled 30 Jan 2019 03:57:02 GMT</title>
  ...
  <style type="text/css" media="screen">
    * {
    ...
    td[class="pattern"] .c56p10r {
      width: 10%;
    }

    td[class="pattern"] .c448p80r {
      width: 80%;
    }

    td[class="pattern"] .c5p1r {
      width: 1%;
    }

    td[class="pattern"] .c548p98r {
      width: 98%;
    }
  </style>
  <style>
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" offset="0" style="font-family:Arial, sans-serif; font-size:0px;margin:0;padding:0;background: #e8e8e8 !important;"
  bgcolor="#e8e8e8">
  <!--[if t]><![endif]-->
  <!--[if t]><![endif]-->
  <!--[if t]><![endif]-->
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                      <tr>
                                        <td valign="top" style="padding:0;mso-cellspacing:0in">
                                          <table cellpadding="0" cellspacing="0" border="0" align="left" width="56" id="c56p10r"
                                            style="float:left" class="c56p10r">
                                            <tr>
                                              <td valign="top" style="padding:0px">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                  <tr>
                                          ...
                                          <table cellpadding="0" cellspacing="0" border="0" align="left" width="448" id="c448p80r"
                                            style="float:left" class="c448p80r">
                                            <tr>
                                              <td valign="top" style="padding:0px">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                  <tr>
                                                    <td valign="top" style="padding:10px">
                                                      <div style="text-align:left;font-family:Verdana, Geneva, sans-serif;font-size:16px;color:#000000;line-height:24px;mso-line-height:exactly;mso-text-raise:4px">
                                                        ...
                                                        <p style="padding: 0; margin: 0;"><br><span style="font-size:14px;"><span
                                                              style="font-size:16px;">C</span>hỉ còn chưa đến 2 ngày
                                              ...
                                              <td valign="top" style="padding:0px">
                                                ...
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                  <tr>
                                                    <td valign="top" style="padding:10px">
                                                      <table cellpadding="0" cellspacing="0" border="0" width="100%"
                                                        bgcolor="#e8e8e8" style="border:0px none;background-color:#e8e8e8">
                                                        <tr>
                                                          <td valign="top" style="padding:0px">
                                                            <table cellpadding="0" cellspacing="0" width="100%">
                                                              <tr>
                                ...
                                <tr>
                                  <td style="padding:0px" class="pattern">
                                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                      <tr>
                                        <td valign="top" style="padding:0;mso-cellspacing:0in">
                                          <table cellpadding="0" cellspacing="0" border="0" align="left" width="5" id="c5p1r"
                                            style="float:left" class="c5p1r">
                                            <tr>
                                              <td valign="top" style="padding:0px">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                  <tr>
                                          ...
                                          <!--[if gte mso 9]></td><td valign="top" style="padding:0;"><![endif]-->
                                          <table cellpadding="0" cellspacing="0" border="0" align="left" width="548" id="c548p98r"
                                            style="float:left" class="c548p98r">
                                            <tr>
                                              <td valign="top" style="padding:0px">
                                                <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                                  <tr>
                          ...
                          <tr>
                            <td valign="top" style="padding:10px">
                              <div style="text-align:left;font-family:Verdana, Geneva, sans-serif;font-size:14px;color:#000000;line-height:20px;mso-line-height:exactly;mso-text-raise:3px">
                                ...
                                <p style="padding: 0; margin: 0;text-align: center;">You received this e-mail, because
                                  you've booked a room at Westay.org</p>
                                <p style="padding: 0; margin: 0;text-align: center;">&nbsp;</p>
                                <p style="padding: 0; margin: 0;text-align: center;"><a href="http://y" style="color: #000000 !important; text-decoration: underline !important;"
                                    target="_blank">
                                    <font style=" color:#000000;">Unsubscribe</font>
                                  </a> | <a href="http://y" style="color: #000000 !important; text-decoration: underline !important;"
                                    target="_blank">
                                    <font style=" color:#000000;">Westay</font>
                                  </a></p>
                                <p style="padding: 0; margin: 0;text-align: center;">&nbsp;</p>
                              </div>
                            </td>
