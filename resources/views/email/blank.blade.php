                                ...
                                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                        <td>
                                            ...
                                            <form action="{!! \Illuminate\Support\Facades\Request::url().'/email-confirm/' . $data->uuid !!}" method="POST">
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr>
                                                                    <td style="margin: 0 auto">
                                                                        <input  style = "background-color: #0693cd;
                                                                                          border: 0;
                                                                                          border-radius: 5px;
                                                                                          cursor: pointer;
                                                                                          color: #fff;
                                                                                          ...
                                                                                          line-height: 1.4;
                                                                                          padding: 10px;
                                                                                          width: 180px" type="submit" value = "Xác nhận" >
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
